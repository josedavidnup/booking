        ...
        auth.user.stripe_seller.charges_enabled && (
          <div className='mt-4'>
            ...
            <button
              ...
              className='mt-4 text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55'
            >
